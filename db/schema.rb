...
ActiveRecord::Schema.define(version: 20161130142948) do
  ...
  create_table "bilawajas", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "session_no"
    t.datetime "created_at",                             null: false
    t.datetime "updated_at",                             null: false
    t.string   "website_id", limit: 6
